...
* **JP Core Observation DentalOral Tooth Treatment Condition Example 口腔診査結果１（現存歯の処置状態）**

## Example Observation: JP Core Observation DentalOral Tooth Treatment Condition Example 口腔診査結果１（現存歯の処置状態）
