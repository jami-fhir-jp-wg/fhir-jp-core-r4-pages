...
* **JP Core Condition Severity ValueSet**

## ValueSet: JP Core Condition Severity ValueSet 
...
* **項目**: *Title*
  * **内容**: JP Core Condition Severity ValueSet
* **項目**: *Status*
  * **内容**: Active ( 2023-10-31 )
* **項目**: *Copyright*
  * **内容**: copyright HL7 Japan (出典：HL7-0421) LocalDefinition

 
Conditionの重症度を示す値セット 
...
* Include all codes defined in [`http://jpfhir.jp/fhir/core/CodeSystem/JP_ConditionSeverity_CS`](https://simplifier.net/resolve?scope=jpfhir-terminology@1.4.0&canonical=http://jpfhir.jp/fhir/core/CodeSystem/JP_ConditionSeverity_CS)version 📦1.1.1
