...
## Resource Profile: JP Core Observation DentalOral Tooth Treatment Condition Profile 
...
* **項目**: *Title*
  * **内容**: JP Core Observation DentalOral Tooth Treatment Condition Profile
* **項目**: *Status*
...
本プロファイルは、口腔診査結果の特定の現存歯の処置後等の状態について、情報の登録や検索、取得のために、FHIR Observationリソースを使用するにあたっての、最低限の制約を記述したものである。 Observation リソースに対して本プロファイルに準拠する場合に必須となる要素や、サポートすべき拡張、用語、検索パラメータを定義する。
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/jpfhir.jp.core|current/StructureDefinition/jp-observation-dentaloral-toothtreatmentcondition)
...
Other representations of profile: [CSV](StructureDefinition-jp-observation-dentaloral-toothtreatmentcondition.csv), [Excel](StructureDefinition-jp-observation-dentaloral-toothtreatmentcondition.xlsx), [Schematron](StructureDefinition-jp-observation-dentaloral-toothtreatmentcondition.sch) 
...
* [**口腔診査結果1（現存歯の処置状態）**](Observation-jp-observation-dentaloral-toothtreatmentcondition-example-1.md)
* [**口腔診査結果2（現存歯の処置状態）**](Observation-jp-observation-dentaloral-toothtreatmentcondition-example-2.md)
* [**口腔診査結果3（現存歯の処置状態）**](Observation-jp-observation-dentaloral-toothtreatmentcondition-example-3.md)
  ...
  "differential" : {
    "element" : [
      ...
      },
      {
        ...
        "short" : "結結果が欠損値である理由 【JP Core仕様】結果が存在しなかった場合、その理由",
        "definition" : "結結果が欠損値である理由 【JP Core仕様】結果が存在しなかった場合、その理由"
      },
      {
      ...
      },
      {
        ...
        "short" : "複合的な結果 【JP Core仕様】特定の現存歯の処置状態",
        "definition" : "複合的な結果 【JP Core仕様】特定の現存歯の処置状態"
      },
      {
      ...
      },
      {
        ...
        "path" : "Observation.component.code.coding",
        "sliceName" : "primary",
        "short" : "細かい粒度の現存歯の処置状態",
        "definition" : "細かい粒度の現存歯の処置状態",
        "min" : 0,
        "max" : "1",
        "binding" : {
          "strength" : "preferred",
          "valueSet" : "http://jpfhir.jp/fhir/core/ValueSet/JP_DentalPresentTeethObservation_VS"
        }
      },
      {
        ...
        "min" : 1,
        "fixedUri" : "http://jpfhir.jp/fhir/core/CodeSystem/JP_DentalPresentTeethObservation_CS"
      },
      {
        ...
        "sliceName" : "sub",
        "short" : "粗い粒度の現存歯の処置状態",
        "definition" : "粗い粒度の現存歯の処置状態",
        "min" : 0,
        "max" : "1",
        "binding" : {
          "strength" : "preferred",
          "valueSet" : "http://jpfhir.jp/fhir/core/ValueSet/JP_DentalSimplePresentTeethObservation_VS"
        }
      },
      {
        ...
        "path" : "Observation.component.code.coding.system",
        "min" : 1,
        "fixedUri" : "http://jpfhir.jp/fhir/core/CodeSystem/JP_DentalSimplePresentTeethObservation_CS"
      }
    ]
  }
}
