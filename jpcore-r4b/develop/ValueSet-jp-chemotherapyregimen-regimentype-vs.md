# JP Core PlanDefinition ChemotherapyRegimen RegimenType ValueSet - HL7 FHIR JP Core ImplementationGuide v2.0.0-dev
...
* Include all codes defined in [`http://jpfhir.jp/fhir/core/CodeSystem/JP_ChemotherapyRegimen_RegimenType_CS`](CodeSystem-jp-chemotherapyregimen-regimentype-cs.md)version 📦2.0.0-dev
