# JP Core Medication Profile - HL7 FHIR JP Core ImplementationGuide v2.0.0-dev-temp
...
* Refer to this Profile: [JP Core ActivityDefinition ChemotherapyRegimen Injection Profile](StructureDefinition-jp-activitydefinition-chemotherapyregimen-injection.md), [JP Core CarePlan Profile](StructureDefinition-jp-careplan.md), [JP Core MedicationAdministration Injection Profile](StructureDefinition-jp-medicationadministration-injection.md), [JP Core MedicationDispense Injection Profile](StructureDefinition-jp-medicationdispense-injection.md)...Show 3 more,[JP Core MedicationRequest Injection Profile](StructureDefinition-jp-medicationrequest-injection.md),[JP Core MedicationStatement Injection Profile](StructureDefinition-jp-medicationstatement-injection.md)and[JP Core Procedure Profile](StructureDefinition-jp-procedure.md)
