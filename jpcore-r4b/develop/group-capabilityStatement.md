# CapabilityStatement - HL7 FHIR JP Core ImplementationGuide v2.0.0-dev-temp
...
FHIR BASEにある定義済み検索パラメータ([Defined Search Parameters](https://www.hl7.org/fhir/R4/searchparameter-registry.html))や[JP Coreで定義された検索パラメータ](group-searchParameter.md)の中より、適合するものがないかを確認しあればこれを採用する。 もし適合するものが見つからない場合、独自にSearch Parameterを定義した上で追加する。
...
[JP Core Server Capability Statement](CapabilityStatement-jp-server-capabilitystatement.md)

#### Client CapabilityStatement

[JP Core Client Capability Statement](CapabilityStatement-jp-client-capabilitystatement.md)
