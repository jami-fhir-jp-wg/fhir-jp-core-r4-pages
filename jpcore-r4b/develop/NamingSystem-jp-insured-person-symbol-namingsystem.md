...
## NamingSystem: jp-insured-person-symbol-namingsystem 
...
* **Type**: OID
  * **Value**: 1.2.392.100495.20.3.62
  * **Preferred**: 
* **Type**: URI
  * **Value**: urn:oid:1.2.392.100495.20.3.62
  * **Preferred**: 
* **Type**: URI
  * **Value**: http://jpfhir.jp/fhir/core/Extension/StructureDefinition/JP_Coverage_InsuredPersonSymbol
  * **Preferred**: true
...
```json
{
  ...
  "id" : "jp-insured-person-symbol-namingsystem",
  "extension" : [
    {
      "url" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-NamingSystem.url",
      "valueUri" : "http://jpfhir.jp/fhir/core/NamingSystem/jp-insured-person-symbol-namingsystem"
    },
    {
