# jp-organization-prefectureno-sp - HL7 FHIR JP Core ImplementationGuide v2.0.0-dev-temp

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **jp-organization-prefectureno-sp**

## SearchParameter: jp-organization-prefectureno-sp 

* **項目**: *定義URL*
  * **内容**: http://jpfhir.jp/fhir/core/SearchParameter/JP_Organization_PrefectureNo_SP
* **項目**: *Version*
  * **内容**: 2.0.0-dev-temp
* **項目**: *Name*
  * **内容**: JP_Organization_PrefectureNo_SP
* **項目**: *Status*
...
Parameter `jp-prefectureno`:`token`

OrganizationリソースのPrefectureNo(都道府県番号)に関する検索を定義する。

| | |
| :--- | :--- |
| Resource | [Organization](http://hl7.org/fhir/R4B/organization.html) |
