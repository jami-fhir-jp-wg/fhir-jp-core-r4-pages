# JP Core Observation BodySite ValueSet - HL7 FHIR JP Core ImplementationGuide v2.0.0-dev-temp

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **JP Core Observation BodySite ValueSet**

## ValueSet: JP Core Observation BodySite ValueSet 

* **項目**: *定義URL*
  * **内容**: http://jpfhir.jp/fhir/core/ValueSet/JP_Observation_BodySite_VS
* **項目**: *Version*
  * **内容**: 2.0.0-dev-temp
* **項目**: *Name*
  * **内容**: JP_Observation_BodySite_VS
* **項目**: *Title*
  * **内容**: JP Core Observation BodySite ValueSet
* **項目**: *Status*
...
```json
{
  ...
  "url" : "http://jpfhir.jp/fhir/core/ValueSet/JP_Observation_BodySite_VS",
  "version" : "2.0.0-dev-temp",
  "name" : "JP_Observation_BodySite_VS",
