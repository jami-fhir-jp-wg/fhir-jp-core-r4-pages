# JP Core Observation Endoscopy Example 診断（腺腫） - HL7 FHIR JP Core ImplementationGuide v2.0.0-dev-temp

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **JP Core Observation Endoscopy Example 診断（腺腫）**

## Example Observation: JP Core Observation Endoscopy Example 診断（腺腫）
...
* [大きさ 長径４（ｍｍ）](Observation-jp-observation-endoscopy-example-findings-1a.md)
* [[大腸 肉眼型1] Is(p)](Observation-jp-observation-endoscopy-example-findings-1b.md)
...
```json
{
  ...
  "id" : "jp-observation-endoscopy-example-diagnosis-1",
  "meta" : {
    "profile" : [
