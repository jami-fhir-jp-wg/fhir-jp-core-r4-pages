# JP Core Observation Endoscopy Example 所見（大きさ 長径５（ｍｍ）） - HL7 FHIR JP Core ImplementationGuide v2.0.0-dev-temp

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **JP Core Observation Endoscopy Example 所見（大きさ 長径５（ｍｍ））**

## Example Observation: JP Core Observation Endoscopy Example 所見（大きさ 長径５（ｍｍ））
...
```json
{
  ...
  "id" : "jp-observation-endoscopy-example-findings-2a",
  "meta" : {
    "profile" : [
