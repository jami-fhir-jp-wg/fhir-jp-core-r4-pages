...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <!-- 
    This file contains just the constraints for the profile JP_MedicationDispenseBase
  ...
  <sch:pattern>
    <sch:title>MedicationDispense.contained</sch:title>
    <sch:rule context="f:MedicationDispense/f:contained">
