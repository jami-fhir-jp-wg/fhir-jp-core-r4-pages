...
* **JP Core Observation DentalOral Missing Tooth Condition Example 口腔診査結果５（欠損歯の状態）**

## Example Observation: JP Core Observation DentalOral Missing Tooth Condition Example 口腔診査結果５（欠損歯の状態）
...
```json
{
  ...
  "id" : "jp-observation-dentaloral-missingtoothcondition-example-5",
  "meta" : {
    "profile" : [
