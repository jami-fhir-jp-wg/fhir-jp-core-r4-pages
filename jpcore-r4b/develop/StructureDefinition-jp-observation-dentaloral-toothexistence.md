# JP Core Observation DentalOral Tooth Existence Profile - HL7 FHIR JP Core ImplementationGuide v2.0.0-dev-temp

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **JP Core Observation DentalOral Tooth Existence Profile**

## Resource Profile: JP Core Observation DentalOral Tooth Existence Profile 

* **項目**: *定義URL*
  * **内容**: http://jpfhir.jp/fhir/core/StructureDefinition/JP_Observation_DentalOral_ToothExistence
* **項目**: *Version*
  * **内容**: 2.0.0-dev-temp
* **項目**: *Name*
  * **内容**: JP_Observation_DentalOral_ToothExistence
* **項目**: *Title*
  * **内容**: JP Core Observation DentalOral Tooth Existence Profile
* **項目**: *Status*
...
Other representations of profile: [CSV](StructureDefinition-jp-observation-dentaloral-toothexistence.csv), [Excel](StructureDefinition-jp-observation-dentaloral-toothexistence.xlsx), [Schematron](StructureDefinition-jp-observation-dentaloral-toothexistence.sch) 
...
* [**口腔診査結果1（歯の有無）**](Observation-jp-observation-dentaloral-toothexistence-example-1.md)
* [**口腔診査結果2（歯の有無）**](Observation-jp-observation-dentaloral-toothexistence-example-2.md)
* [**口腔診査結果3（歯の有無）**](Observation-jp-observation-dentaloral-toothexistence-example-3.md)
* [**口腔診査結果4（歯の有無）**](Observation-jp-observation-dentaloral-toothexistence-example-4.md)
* [**口腔診査結果5（歯の有無）**](Observation-jp-observation-dentaloral-toothexistence-example-5.md)
* [**口腔診査結果6（歯の有無）**](Observation-jp-observation-dentaloral-toothexistence-example-6.md)
...
```json
{
  ...
  "name" : "JP_Observation_DentalOral_ToothExistence",
  ...
  "differential" : {
    "element" : [
      ...
      },
      {
        ...
        "short" : "このObservationの対象を特定するコード。LOINCより歯の有無・状態を表す54570-7を選択する。",
        "definition" : "このObservationの対象を特定するコード。LOINCより歯の有無・状態を表す54570-7を選択する。"
      },
      {
      ...
      },
      {
        ...
        "short" : "実際の結果値 【JP Core仕様】特定の歯の有無",
        "definition" : "実際の結果値 【JP Core仕様】特定の歯の有無",
        "type" : [
          {
        ...
        "binding" : {
          "strength" : "preferred",
          "valueSet" : "http://jpfhir.jp/fhir/core/ValueSet/JP_DentalFundamentalStatus_VS"
        }
      },
      {
      ...
      },
      {
        ...
        "short" : "observationグループに属する関連リソース 【JP Core仕様】現存歯もしくは欠損歯に対応する処置状態のObservationリソースを参照",
        "definition" : "observationグループに属する関連リソース 【JP Core仕様】現存歯もしくは欠損歯に対応する処置状態のObservationリソースを参照",
        "type" : [
          {
            "code" : "Reference",
            "targetProfile" : [
