...
## Extension: JP Core Immunization ManufacturedDate Extension 
...
* **項目**: *Title*
  * **内容**: JP Core Immunization ManufacturedDate Extension
* **項目**: *Status*
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/jpfhir.jp.core|current/StructureDefinition/jp-immunization-manufactureddate)
...
Other representations of profile: [CSV](StructureDefinition-jp-immunization-manufactureddate.csv), [Excel](StructureDefinition-jp-immunization-manufactureddate.xlsx), [Schematron](StructureDefinition-jp-immunization-manufactureddate.sch) 
  ...
  "differential" : {
    "element" : [
      ...
      },
      {
        "id" : "Extension.url",
        "path" : "Extension.url",
        "fixedUri" : "http://jpfhir.jp/fhir/core/Extension/StructureDefinition/JP_Immunization_ManufacturedDate"
      },
      {
