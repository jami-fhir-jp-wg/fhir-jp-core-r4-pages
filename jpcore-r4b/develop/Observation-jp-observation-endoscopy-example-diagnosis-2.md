# JP Core Observation Endoscopy Example 診断（[鋸歯状病変] HP） - HL7 FHIR JP Core ImplementationGuide v2.0.0-dev-temp

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **JP Core Observation Endoscopy Example 診断（[鋸歯状病変] HP）**

## Example Observation: JP Core Observation Endoscopy Example 診断（[鋸歯状病変] HP）
...
* [大きさ 長径５（ｍｍ）](Observation-jp-observation-endoscopy-example-findings-2a.md)
* [[大腸 肉眼型1] IIa](Observation-jp-observation-endoscopy-example-findings-2b.md)
...
```json
{
  ...
  "id" : "jp-observation-endoscopy-example-diagnosis-2",
  "meta" : {
    "profile" : [
