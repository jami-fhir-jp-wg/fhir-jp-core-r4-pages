...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    <sch:title>Coverage.contained</sch:title>
    <sch:rule context="f:Coverage/f:contained">
  ...
  <sch:pattern>
    <sch:title>f:Coverage/f:costToBeneficiary/f:type</sch:title>
  ...
  <sch:pattern>
    <sch:title>f:Coverage/f:costToBeneficiary/f:type/f:coding</sch:title>
    <sch:rule context="f:Coverage/f:costToBeneficiary/f:type/f:coding">
      <sch:assert test="count(f:id) &lt;= 1">id: maximum cardinality of 'id' is 1</sch:assert>
  ...
  <sch:pattern>
    <sch:title>Coverage.costToBeneficiary.type.coding</sch:title>
    <sch:rule context="f:Coverage/f:costToBeneficiary/f:type/f:coding">
      <sch:assert test="@value|f:*|h:div">All FHIR elements must have a @value or children (inherited)</sch:assert>
    </sch:rule>
  </sch:pattern>
  ...
  <sch:pattern>
    <sch:title>Coverage.costToBeneficiary.type.coding.system</sch:title>
    <sch:rule context="f:Coverage/f:costToBeneficiary/f:type/f:coding/f:system">
      <sch:assert test="@value|f:*|h:div">All FHIR elements must have a @value or children (inherited)</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
    <sch:title>Coverage.costToBeneficiary.type.coding.version</sch:title>
    <sch:rule context="f:Coverage/f:costToBeneficiary/f:type/f:coding/f:version">
      <sch:assert test="@value|f:*|h:div">All FHIR elements must have a @value or children (inherited)</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
    <sch:title>Coverage.costToBeneficiary.type.coding.code</sch:title>
    <sch:rule context="f:Coverage/f:costToBeneficiary/f:type/f:coding/f:code">
      <sch:assert test="@value|f:*|h:div">All FHIR elements must have a @value or children (inherited)</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
    <sch:title>Coverage.costToBeneficiary.type.coding.display</sch:title>
    <sch:rule context="f:Coverage/f:costToBeneficiary/f:type/f:coding/f:display">
      <sch:assert test="@value|f:*|h:div">All FHIR elements must have a @value or children (inherited)</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
    <sch:title>Coverage.costToBeneficiary.type.coding.userSelected</sch:title>
    <sch:rule context="f:Coverage/f:costToBeneficiary/f:type/f:coding/f:userSelected">
      <sch:assert test="@value|f:*|h:div">All FHIR elements must have a @value or children (inherited)</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
    <sch:title>Coverage.costToBeneficiary.type.text</sch:title>
    <sch:rule context="f:Coverage/f:costToBeneficiary/f:type/f:text">
      <sch:assert test="@value|f:*|h:div">All FHIR elements must have a @value or children (inherited)</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
