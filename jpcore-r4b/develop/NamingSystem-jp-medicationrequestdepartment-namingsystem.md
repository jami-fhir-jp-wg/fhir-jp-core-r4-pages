...
* **jp-medicationrequestdepartment-namingsystem**

## NamingSystem: jp-medicationrequestdepartment-namingsystem 
...
* **項目**: *Status*
  * **内容**: Active ( 2025-01-01 )
* **項目**: *Copyright*
  * **内容**: Copyright Japan FHIR Implementation Infrastructure Study Group in Japan Association of Medical Informatics (JAMI) 一般社団法人日本医療情報学会FHIR国内実装基盤研究会

 
JP Core MedicationRequestDepartment NamingSystem 処方オーダ時に使用する診療科コード。医療機関固有の診療科コードを識別するためのコード体系。 
...
* **Type**: OID
  * **Value**: 1.2.392.100495.20.2.51
  * **Preferred**: 
* **Type**: URI
  * **Value**: urn:oid:1.2.392.100495.20.2.51
  * **Preferred**: 
* **Type**: URI
  * **Value**: http://jpfhir.jp/fhir/core/mhlw/CodeSystem/MedicationRequestDepartment
  * **Preferred**: true
...
```json
{
  ...
  "id" : "jp-medicationrequestdepartment-namingsystem",
  "extension" : [
    {
      "url" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-NamingSystem.url",
      "valueUri" : "http://jpfhir.jp/fhir/core/NamingSystem/jp-medicationrequestdepartment-namingsystem"
    },
    {
