...
* **JP Core PlanDefinition ChemotherapyRegimen TimingDaysOfCycle Extension**

## Extension: JP Core PlanDefinition ChemotherapyRegimen TimingDaysOfCycle Extension 
...
* **項目**: *Title*
  * **内容**: JP Core PlanDefinition ChemotherapyRegimen TimingDaysOfCycle Extension
* **項目**: *Status*
  * **内容**: Draft ( 2023-11-30 )
* **項目**: *Copyright*
  * **内容**: Copyright Japan FHIR Implementation Infrastructure Study Group in Japan Association of Medical Informatics (JAMI) 一般社団法人日本医療情報学会FHIR国内実装基盤研究会

周期の日数に関する情報を格納するためのExtension。
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/jpfhir.jp.core|current/StructureDefinition/jp-plandefinition-chemotherapyregimen-timingdaysofcycle)
...
Other representations of profile: [CSV](StructureDefinition-jp-plandefinition-chemotherapyregimen-timingdaysofcycle.csv), [Excel](StructureDefinition-jp-plandefinition-chemotherapyregimen-timingdaysofcycle.xlsx), [Schematron](StructureDefinition-jp-plandefinition-chemotherapyregimen-timingdaysofcycle.sch) 
    ...
    "element" : [
      {
        ...
        "path" : "Extension",
        "short" : "【仮】周期の日数に関する情報",
        "definition" : "周期の日数に関する情報を格納するためのExtension。",
