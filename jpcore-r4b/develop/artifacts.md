...
| | |
| :--- | :--- |
| [JP Core ActivityDefinition ChemotherapyRegimen Injection Profile](StructureDefinition-jp-activitydefinition-chemotherapyregimen-injection.md) | このプロファイルはActivityDefinitionリソースに対して、化学療法レジメンの定義に関する情報を送受信するための共通の制約と拡張を定めたものである。 |
| [JP Core ActivityDefinition ChemotherapyRegimen Oral Profile](StructureDefinition-jp-activitydefinition-chemotherapyregimen-oral.md) | このプロファイルはActivityDefinitionリソースに対して、化学療法レジメンの定義に関する情報を送受信するための共通の制約と拡張を定めたものである。 |
...
| [JP Core CarePlan Profile](StructureDefinition-jp-careplan.md) | このプロファイルはJP Core CarePlanリソースに対する共通の制約と拡張を定めたものである。 |
...
| [JP Core Consent Profile](StructureDefinition-jp-consent.md) | Detailed Descriptions for the elements in the Consent resource. |
...
| [JP Core PlanDefinition ChemotherapyRegimen Profile](StructureDefinition-jp-plandefinition-chemotherapyregimen.md) | このプロファイルはPlanDefinitionリソースに対して、化学療法レジメンの定義に関する情報を送受信するための共通の制約と拡張を定めたものである。 |
...
| [JP Core PlanDefinition ChemotherapyRegimen RegimenType Extension](StructureDefinition-jp-plandefinition-chemotherapyregimen-regimentype.md) | レジメン種別に関する情報を格納するためのExtension。 |
| [JP Core PlanDefinition ChemotherapyRegimen TimingDaysOfCycle Extension](StructureDefinition-jp-plandefinition-chemotherapyregimen-timingdaysofcycle.md) | 周期の日数に関する情報を格納するためのExtension。 |
...
| [JP Core Condition Disease Code ICD-10 ValueSet](ValueSet-jp-condition-disease-code-icd10-vs.md) | ICD-10コードを示す値セット |
| [JP Core Condition Disease Code MEDIS Exchange ValueSet](ValueSet-jp-condition-disease-code-medis-exchange-vs.md) | MEDIS ICD10対応標準病名マスター(交換用コード) を示す値セット |
| [JP Core Condition Disease Code MEDIS RecordNo ValueSet](ValueSet-jp-condition-disease-code-medis-record-no-vs.md) | MEDIS ICD10対応標準病名マスター(管理番号) を示す値セット |
| [JP Core Condition Disease Code Receipt System ValueSet](ValueSet-jp-condition-disease-code-receipt-vs.md) | レセプト電算用傷病名マスターを示す値セット |
| [JP Core Condition Disease Modifier MEDIS Exchange ValueSet](ValueSet-jp-condition-disease-modifier-medis-exchange-vs.md) | MEDIS ICD10対応標準病名マスター(修飾語交換用コード) を示す値セット |
| [JP Core Condition Disease Modifier MEDIS Record No ValueSet](ValueSet-jp-condition-disease-modifier-medis-record-no-vs.md) | MEDIS ICD10対応標準病名マスター(修飾語管理番号) を示す値セット |
| [JP Core Condition Disease Modifier Receipt System ValueSet](ValueSet-jp-condition-disease-modifier-receipt-vs.md) | レセプト電算用修飾語マスターを示す値セット |
| [JP Core Condition Disease Outcome HL70241 ValueSet](ValueSet-jp-condition-disease-outcome-hl70241-vs.md) | HL7表0241の病名転帰区分を示す値セット |
| [JP Core Condition Disease Outcome HL70241+JHSD0006 ValueSet](ValueSet-jp-condition-disease-outcome-hl70241-jhsd0006-vs.md) | HL7表0241+JHSD表0006の病名転帰区分を示す値セット |
| [JP Core Condition Disease Outcome JHSD0006 ValueSet](ValueSet-jp-condition-disease-outcome-jhsd0006-vs.md) | JHSD表0006の病名転帰区分を示す値セット |
...
| [JP Core Condition Severity ValueSet](ValueSet-jp-condition-severity-vs.md) | Conditionの重症度を示す値セット |
...
| [JP Core DiagnosticReport Endoscopy Conclusion Codes JED ValueSet](ValueSet-jp-conclusion-codes-jed-vs.md) | 日本消化器内視鏡学会が推進するJED (Japan Endoscopy Database) Projectのコード値セットのうち主に「質的診断」に該当するコード |
| [JP Core ImagingStudy Endoscopy Reason Code JED ValueSet](ValueSet-jp-reason-codes-jed-vs.md) | 日本消化器内視鏡学会が推進するJED (Japan Endoscopy Database) Projectのコード値セットのうち「検査目的」、「治療目的」に該当するコード |
...
| [JP Core Physical Exam Code ValueSet](ValueSet-jp-physicalexamcode-vs.md) | 身体所見の区分を表す値セット |
| [JP Core PlanDefinition ChemotherapyRegimen RegimenType ValueSet](ValueSet-jp-chemotherapyregimen-regimentype-vs.md) | 【仮】レジメン種別コード |
| [JP Core Procedure BodySite ValueSet](ValueSet-jp-procedure-body-site-vs.md) | 処置の対象となる身体部位のコード |
| [JP Core Procedure Codes ICHI ValueSet](ValueSet-jp-procedure-codes-ichi-vs.md) | 処置のコード:ICHI(International Classification of Health Interventions)の値セット |
| [JP Core Procedure Condition ValueSet](ValueSet-jp-procedure-condition-vs.md) | 処置中もしくは処置の後に発生した合併症を示すコード(Condition/Problem/Diagnosis)の値セット |
| [JP Core Procedure Device Action ValueSet](ValueSet-jp-procedure-device-action-vs.md) | 処置の実施中に機器に起こった変化を示す値セット |
| [JP Core Procedure Device Kind ValueSet](ValueSet-jp-procedure-devicekind-vs.md) | 処置の実施に利用された医療機器を識別する値セット |
| [JP Core Procedure Follow Up ValueSet](ValueSet-jp-procedure-followup-vs.md) | 処置のフォローアップとして実施される処置の値セット |
| [JP Core Procedure Not Performed Reason ValueSet](ValueSet-jp-procedure-not-performed-reason-vs.md) | 処置が実施されなかった理由、または開始された処置が完了しなかった理由を示す値セット |
| [JP Core Procedure Outcome ValueSet](ValueSet-jp-procedure-outcome-vs.md) | 処置が実施されたアウトカムを示す値セット |
| [JP Core Procedure Performer Role ValueSet](ValueSet-jp-procedure-performer-role-vs.md) | 処置を実施した者の役割（ロール）を示す値セット |
| [JP Core Procedure Reason ValueSet](ValueSet-jp-procedure-reason-vs.md) | 処置が実施された理由を示す値セット |
| [JP Core Simple Observation Category ValueSet](ValueSet-jp-simpleobservationcategory-vs.md) | JP Coreにて定義したObservationリソースに関する分類の値セット |
...
| | |
| :--- | :--- |
| [JP Core Condition Disease Code ICD-10 CodeSystem](CodeSystem-jp-condition-disease-code-icd10-cs.md) | ICD-10 コードシステム |
| [JP Core Condition Disease Code MEDIS Exchange CodeSystem](CodeSystem-jp-condition-disease-code-medis-exchange-cs.md) | MEDIS ICD10対応標準病名マスター(交換用コード) コードシステム |
| [JP Core Condition Disease Code MEDIS Record No CodeSystem](CodeSystem-jp-condition-disease-code-medis-record-no-cs.md) | MEDIS ICD10対応標準病名マスター(管理番号) コードシステム |
| [JP Core Condition Disease Code Receipt System CodeSystem](CodeSystem-jp-condition-disease-code-receipt-cs.md) | レセプト電算用傷病名マスター コードシステム |
| [JP Core Condition Disease Modifier MEDIS Exchange CodeSystem](CodeSystem-jp-condition-disease-modifier-medis-exchange-cs.md) | MEDIS ICD10対応標準病名マスター(修飾語交換用コード) コードシステム |
| [JP Core Condition Disease Modifier MEDIS Record CodeSystem](CodeSystem-jp-condition-disease-modifier-medis-record-no-cs.md) | MEDIS ICD10対応標準病名マスター(修飾語管理番号) コードシステム |
| [JP Core Condition Disease Modifier Receipt System CodeSystem](CodeSystem-jp-condition-disease-modifier-receipt-cs.md) | レセプト電算用修飾語マスター コードシステム |
...
| [JP Core Condition Disease Outcome JHSD0006 CodeSystem](CodeSystem-jp-condition-disease-outcome-jhsd0006-cs.md) | JAHIS病名情報データ交換規約Ver.3.1C JHSD表00006-転帰区分 コードシステム |
...
| [JP Core Physical Exam Code CodeSystem](CodeSystem-jp-physicalexamcode-cs.md) | 身体所見の区分を表すコード |
| [JP Core PlanDefinition ChemotherapyRegimen RegimenType CodeSystem](CodeSystem-jp-chemotherapyregimen-regimentype-cs.md) | 【仮】レジメン種別コード |
| [JP Core Procedure Not Performed Reason CodeSystem](CodeSystem-jp-procedure-not-performed-reason-cs.md) | 処置が実施されなかった理由、または開始された処置が完了しなかった理由を示すコード（より適切なコードと用語に見直し必要） |
| [JP Core Procedure Outcome CodeSystem](CodeSystem-jp-procedure-outcome-cs.md) | 処置が実施されたアウトカムを示すコードシステム（より適切なコードと用語に見直し必要） |
| [JP Core Simple Observation Category CodeSystem](CodeSystem-jp-simpleobservationcategory-cs.md) | JP Coreにて定義したObservationリソースに関する分類コード |
