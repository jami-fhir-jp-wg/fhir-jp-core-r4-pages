# jp-medis-observation-jlac10-namingsystem - HL7 FHIR JP Core ImplementationGuide v2.0.0-dev-temp

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **jp-medis-observation-jlac10-namingsystem**

## NamingSystem: jp-medis-observation-jlac10-namingsystem 

* **項目**: *定義URL*
  * **内容**: http://jpfhir.jp/fhir/core/NamingSystem/jp-medis-observation-jlac10-namingsystem
* **項目**: *Version*
  * **内容**: 2.0.0-dev-temp
* **項目**: *Name*
  * **内容**: JP_MEDIS_Observation_JLAC10_CodeSystem
* **項目**: *Status*
...
```json
{
  ...
  "id" : "jp-medis-observation-jlac10-namingsystem",
  "extension" : [
    {
      "url" : "http://hl7.org/fhir/5.0/StructureDefinition/extension-NamingSystem.url",
      "valueUri" : "http://jpfhir.jp/fhir/core/NamingSystem/jp-medis-observation-jlac10-namingsystem"
    },
    {
