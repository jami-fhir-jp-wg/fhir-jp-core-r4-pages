# JP Core Observation Radiology Impression Profile - HL7 FHIR JP Core ImplementationGuide v2.0.0-dev-temp
...
* **項目**: *定義URL*
  * **内容**: http://jpfhir.jp/fhir/core/StructureDefinition/JP_Observation_Radiology_Impression
* **項目**: *Version*
  * **内容**: 2.0.0-dev-temp
* **項目**: *Name*
  * **内容**: JP_Observation_Radiology_Impression
* **項目**: *Title*
  * **内容**: JP Core Observation Radiology Impression Profile
* **項目**: *Status*
...
* Examples for this Profile: [Observation/jp-observation-radiology-impression-example-1](Observation-jp-observation-radiology-impression-example-1.md)
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/jpfhir.jp.core|current/StructureDefinition/jp-observation-radiology-impression)
...
Other representations of profile: [CSV](StructureDefinition-jp-observation-radiology-impression.csv), [Excel](StructureDefinition-jp-observation-radiology-impression.xlsx), [Schematron](StructureDefinition-jp-observation-radiology-impression.sch) 
...
本バージョンの実装ガイドではCategoryの第1コードとして[JP Core Simple Observation Category ValueSet](ValueSet-jp-simpleobservationcategory-vs.md)から`imaging`を指定する。

### code

[JP Core Observation Radiolgoy Code ValueSet](ValueSet-jp-observation-radiology-code-vs.md)の中から`19005-8`, Radiology Imaging study (Impression) (narrative)を指定する。
...
* [**放射線読影レポート（インプレッション）**](Observation-jp-observation-radiology-impression-example-1.md)
...
```json
{
  ...
  "name" : "JP_Observation_Radiology_Impression",
  ...
  "differential" : {
    "element" : [
      ...
      },
      {
        ...
        "comment" : "このObservation（インプレッション）が生成される元になった画像検査",
        "type" : [
          {
            "code" : "Reference",
            "targetProfile" : [
      ...
      },
      {
        ...
        "comment" : "observation(インプレッション)を表すLOINCコード。19005-8, Radiology Imaging study [Impression] (narrative)が指定される。"
      },
      {
      ...
      },
      {
        ...
        "comment" : "「結論」が確定された日時(DateTime)。参照元のDiagnosticReportの日時と一致する必要がある。"
      },
      {
        "id" : "Observation.performer",
        "path" : "Observation.performer",
        "comment" : "「結論」を生成した医療者。通常は読影医。",
        "type" : [
          {
            "code" : "Reference",
            "targetProfile" : [
