# Search Parameter - HL7 FHIR JP Core ImplementationGuide v2.0.0-dev-temp
...
FHIR Baseにて定義済み検索パラメータ([Defined Search Parameters](https://www.hl7.org/fhir/R4B/searchparameter-registry.html))が記載されており、相互運用性の高めるためにもこれを利用することを推奨する(**SHOULD**)。
