...
* Refer to this Profile: [JP Core Encounter Profile](StructureDefinition-jp-encounter.md), [JP Core ImagingStudy Endoscopy Profile](StructureDefinition-jp-imagingstudy-endoscopy.md), [JP Core ImagingStudy Radiology Profile](StructureDefinition-jp-imagingstudy-radiology.md), [JP Core MedicationDispenseBase Profile](StructureDefinition-jp-medicationdispensebase.md)...Show 2 more,[JP Core Observation Common Profile](StructureDefinition-jp-observation-common.md)and[JP Core Procedure Profile](StructureDefinition-jp-procedure.md)
