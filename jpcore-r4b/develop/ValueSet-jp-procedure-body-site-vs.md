# JP Core Procedure BodySite ValueSet - HL7 FHIR JP Core ImplementationGuide v2.0.0-dev-temp

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **JP Core Procedure BodySite ValueSet**

## ValueSet: JP Core Procedure BodySite ValueSet 

* **項目**: *定義URL*
  * **内容**: http://jpfhir.jp/fhir/core/ValueSet/JP_ProcedureBodySite_VS
* **項目**: *Version*
  * **内容**: 2.0.0-dev-temp
* **項目**: *Name*
  * **内容**: JP_ProcedureBodySite_VS
* **項目**: *Title*
  * **内容**: JP Core Procedure BodySite ValueSet
* **項目**: *Status*
...
```json
{
  ...
  "url" : "http://jpfhir.jp/fhir/core/ValueSet/JP_ProcedureBodySite_VS",
  "version" : "2.0.0-dev-temp",
  "name" : "JP_ProcedureBodySite_VS",
