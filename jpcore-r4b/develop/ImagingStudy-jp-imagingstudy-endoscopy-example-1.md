# JP Core ImagingStudy Endoscopy Example 内視鏡画像検査 - HL7 FHIR JP Core ImplementationGuide v2.0.0-dev-temp
...
**identifier**: [DICOM Unique Id](http://terminology.hl7.org/7.0.1/NamingSystem-dui.html)/urn:oid:2.16.124.113543.6003.1154777499.30246.19789.20230425001

**status**: Available

**modality**: [DICOM: ES](http://hl7.org/fhir/R4B/codesystem-dicom-dcim.html#dicom-dcim-ES) (Endoscopy)
...
> **series****uid**: 2.16.124.113543.6003.1154777499.30246.19789.20230425001.1**number**: 1**modality**:[DICOM: ES](http://hl7.org/fhir/R4B/codesystem-dicom-dcim.html#dicom-dcim-ES)(Endoscopy)**numberOfInstances**: 5**endpoint**:[Endpoint ABC Hospital PACS DICOM WADO-RS endpoint](Endpoint-endpoint-dicom-wadors-example.md)
