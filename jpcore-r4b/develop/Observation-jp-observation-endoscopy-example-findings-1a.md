...
* **JP Core Observation Endoscopy Example 所見（大きさ 長径４（ｍｍ））**

## Example Observation: JP Core Observation Endoscopy Example 所見（大きさ 長径４（ｍｍ））
...
```json
{
  ...
  "id" : "jp-observation-endoscopy-example-findings-1a",
  "meta" : {
    "profile" : [
