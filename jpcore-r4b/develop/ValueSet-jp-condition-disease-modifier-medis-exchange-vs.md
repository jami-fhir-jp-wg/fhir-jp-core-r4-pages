...
* **JP Core Condition Disease Modifier MEDIS Exchange ValueSet**

## ValueSet: JP Core Condition Disease Modifier MEDIS Exchange ValueSet 
...
* **項目**: *Title*
  * **内容**: JP Core Condition Disease Modifier MEDIS Exchange ValueSet
* **項目**: *Status*
...
MEDIS ICD10対応標準病名マスター(修飾語交換用コード) を示す値セット 
...
This value set contains at least 3 concepts
...
```json
{
  ...
  "compose" : {
    "include" : [
      {
        "system" : "urn:oid:1.2.392.200119.4.201.5"
      },
      {
