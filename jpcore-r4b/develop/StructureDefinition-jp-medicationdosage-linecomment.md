...
## Extension: JP Core Medication Dosage LineComment Extension 
...
* **項目**: *Title*
  * **内容**: JP Core Medication Dosage LineComment Extension
* **項目**: *Status*
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/jpfhir.jp.core|current/StructureDefinition/jp-medicationdosage-linecomment)
...
Other representations of profile: [CSV](StructureDefinition-jp-medicationdosage-linecomment.csv), [Excel](StructureDefinition-jp-medicationdosage-linecomment.xlsx), [Schematron](StructureDefinition-jp-medicationdosage-linecomment.sch) 
  ...
  "differential" : {
    "element" : [
      ...
      },
      {
        "id" : "Extension.url",
        "path" : "Extension.url",
        "fixedUri" : "http://jpfhir.jp/fhir/core/Extension/StructureDefinition/JP_MedicationDosage_LineComment"
      },
      {
      ...
      },
      {
        ...
        "binding" : {
          "strength" : "example",
          "valueSet" : "http://jpfhir.jp/fhir/Examples/ValueSet/JP_MedicationAdministrationDosageLineComment_VS"
        }
      },
      {
