...
* **JP Core Condition Disease Code Receipt System ValueSet**

## ValueSet: JP Core Condition Disease Code Receipt System ValueSet 
...
* **項目**: *Title*
  * **内容**: JP Core Condition Disease Code Receipt System ValueSet
* **項目**: *Status*
...
```json
{
  ...
  "compose" : {
    "include" : [
      {
        "system" : "http://jpfhir.jp/fhir/core/CodeSystem/JP_ConditionDiseaseCodeReceipt_CS"
      }
    ]
  }
}
