...
* 他のリソースからの放射線検査レポートの参照
 （例：[ImagingStudyリソース](StructureDefinition-jp-imagingstudy-radiology.md)） や[ServiceRequestリソース](https://www.hl7.org/fhir/R4B/servicerequest.html) のreasonReference エレメントで参照される放射線検査レポート）
...
* 感染症情報 [(`RiskAssessment`)](https://hl7.org/fhir/R4B/riskassessment.html) あるいは [(`Observation`)](StructureDefinition-jp-observation-labresult.md)
...
| MAY | based-on | reference | オーダ情報への参照 | DiagnosticReport.basedOn ([ServiceRequest](https://hl7.org/fhir/R4B/servicerequest.html)) | GET [base]/DiagnosticReport?ServiceRequest/12345 |
