...
## Resource Profile: JP_RelatedPerson 
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/jpfhir.jp.core|current/StructureDefinition/jp-relatedperson)
...
Other representations of profile: [CSV](StructureDefinition-jp-relatedperson.csv), [Excel](StructureDefinition-jp-relatedperson.xlsx), [Schematron](StructureDefinition-jp-relatedperson.sch) 
