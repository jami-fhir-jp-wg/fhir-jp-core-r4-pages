# JP Core MedicationStatement Profile - HL7 FHIR JP Core ImplementationGuide v2.0.0-dev-temp
...
* **項目**: *定義URL*
  * **内容**: http://jpfhir.jp/fhir/core/StructureDefinition/JP_MedicationStatement
* **項目**: *Version*
  * **内容**: 2.0.0-dev-temp
* **項目**: *Name*
  * **内容**: JP_MedicationStatement
* **項目**: *Title*
  * **内容**: JP Core MedicationStatement Profile
* **項目**: *Status*
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/jpfhir.jp.core|current/StructureDefinition/jp-medicationstatement)
...
Other representations of profile: [CSV](StructureDefinition-jp-medicationstatement.csv), [Excel](StructureDefinition-jp-medicationstatement.xlsx), [Schematron](StructureDefinition-jp-medicationstatement.sch) 
...
* [**服薬情報 内服薬**](MedicationStatement-jp-medicationstatement-example-1.md)
...
薬が服用された（または服用される予定の）日時をeffectiveDateTime or effectivePeriod要素に[RFC3339](https://datatracker.ietf.org/doc/html/rfc3339)形式で記述する。 タイムゾーンはJST(+09:00)を指定する。
...
この投薬の理由、対象疾患などを、reasonCode要素にCodeableConcept型で記述する。 服用理由で使用するコードは、MEDIS標準病名マスター 病名交換用コード("http://medis.or.jp/CodeSystem/master-disease-exCode")を推奨する。
