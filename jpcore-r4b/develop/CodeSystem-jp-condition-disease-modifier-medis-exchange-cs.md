...
* **JP Core Condition Disease Modifier MEDIS Exchange CodeSystem**

## CodeSystem: JP Core Condition Disease Modifier MEDIS Exchange CodeSystem 
...
* **項目**: *Title*
  * **内容**: JP Core Condition Disease Modifier MEDIS Exchange CodeSystem
* **項目**: *Status*
...
MEDIS ICD10対応標準病名マスター(修飾語交換用コード) コードシステム 
