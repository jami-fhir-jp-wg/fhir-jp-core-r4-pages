# JP Core MedicationDosage DataType - HL7 FHIR JP Core ImplementationGuide v2.0.0-dev-temp
...
* Use this DataType Profile: [JP Core ActivityDefinition ChemotherapyRegimen Oral Profile](StructureDefinition-jp-activitydefinition-chemotherapyregimen-oral.md), [JP Core MedicationDispense Profile](StructureDefinition-jp-medicationdispense.md), [JP Core MedicationRequest Profile](StructureDefinition-jp-medicationrequest.md) and [JP Core MedicationStatement Profile](StructureDefinition-jp-medicationstatement.md)
