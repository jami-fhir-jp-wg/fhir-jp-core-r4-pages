...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    <sch:title>f:PlanDefinition/f:useContext</sch:title>
  ...
  <sch:pattern>
    <sch:title>f:PlanDefinition/f:useContext/f:code</sch:title>
    <sch:rule context="f:PlanDefinition/f:useContext/f:code">
      <sch:assert test="count(f:id) &lt;= 1">id: maximum cardinality of 'id' is 1</sch:assert>
      <sch:assert test="count(f:system) &lt;= 1">system: maximum cardinality of 'system' is 1</sch:assert>
      <sch:assert test="count(f:version) &lt;= 1">version: maximum cardinality of 'version' is 1</sch:assert>
      <sch:assert test="count(f:code) &lt;= 1">code: maximum cardinality of 'code' is 1</sch:assert>
  ...
  <sch:pattern>
    <sch:title>f:PlanDefinition/f:useContext/f:value[x] 1</sch:title>
    <sch:rule context="f:PlanDefinition/f:useContext/f:value[x]">
      <sch:assert test="count(f:id) &lt;= 1">id: maximum cardinality of 'id' is 1</sch:assert>
      <sch:assert test="count(f:text) &lt;= 1">text: maximum cardinality of 'text' is 1</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
    <sch:title>f:PlanDefinition/f:useContext/f:value[x]/f:coding 1</sch:title>
    <sch:rule context="f:PlanDefinition/f:useContext/f:value[x]/f:coding">
      <sch:assert test="count(f:id) &lt;= 1">id: maximum cardinality of 'id' is 1</sch:assert>
