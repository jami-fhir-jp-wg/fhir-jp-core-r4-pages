...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    <sch:title>ImagingStudy.contained</sch:title>
    <sch:rule context="f:ImagingStudy/f:contained">
  ...
  <sch:pattern>
    <sch:title>ImagingStudy.status</sch:title>
    <sch:rule context="f:ImagingStudy/f:status">
      <sch:assert test="@value|f:*|h:div">All FHIR elements must have a @value or children (inherited)</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
    <sch:title>ImagingStudy.modality</sch:title>
    <sch:rule context="f:ImagingStudy/f:modality">
      <sch:assert test="@value|f:*|h:div">All FHIR elements must have a @value or children (inherited)</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
    <sch:title>ImagingStudy.subject</sch:title>
    <sch:rule context="f:ImagingStudy/f:subject">
      <sch:assert test="@value|f:*|h:div">All FHIR elements must have a @value or children (inherited)</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
    <sch:title>ImagingStudy.encounter</sch:title>
  ...
  <sch:pattern>
    <sch:title>ImagingStudy.location</sch:title>
    <sch:rule context="f:ImagingStudy/f:location">
      <sch:assert test="@value|f:*|h:div">All FHIR elements must have a @value or children (inherited)</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
    <sch:title>ImagingStudy.reasonCode</sch:title>
    <sch:rule context="f:ImagingStudy/f:reasonCode">
      <sch:assert test="@value|f:*|h:div">All FHIR elements must have a @value or children (inherited)</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
    <sch:title>ImagingStudy.reasonReference</sch:title>
    <sch:rule context="f:ImagingStudy/f:reasonReference">
      <sch:assert test="@value|f:*|h:div">All FHIR elements must have a @value or children (inherited)</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
    <sch:title>ImagingStudy.note</sch:title>
    <sch:rule context="f:ImagingStudy/f:note">
      <sch:assert test="@value|f:*|h:div">All FHIR elements must have a @value or children (inherited)</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
  ...
  <sch:pattern>
    <sch:title>ImagingStudy.series.specimen</sch:title>
  ...
  <sch:pattern>
    <sch:title>ImagingStudy.series.performer.modifierExtension</sch:title>
    <sch:rule context="f:ImagingStudy/f:series/f:performer/f:modifierExtension">
      <sch:assert test="@value|f:*|h:div">All FHIR elements must have a @value or children (inherited)</sch:assert>
      <sch:assert test="exists(f:extension)!=exists(f:*[starts-with(local-name(.), &quot;value&quot;)])">Must have either extensions or value[x], not both (inherited)</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
    <sch:title>ImagingStudy.series.performer.function</sch:title>
    <sch:rule context="f:ImagingStudy/f:series/f:performer/f:function">
      <sch:assert test="@value|f:*|h:div">All FHIR elements must have a @value or children (inherited)</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
    <sch:title>ImagingStudy.series.performer.actor</sch:title>
